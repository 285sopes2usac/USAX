...
#include <usax/kernel/hal_types.h>
...
#define USERMODE_STACK_ALIGN              16ul
   ...
   #include <usax/kernel/arch/generic_x86/fpu_memcpy.h>
   #include <usax/kernel/arch/generic_x86/arch_ints.h>

   #if defined(__x86_64__)

      #include <usax/common/arch/x86_64/utils.h>
      #include <usax/kernel/arch/x86_64/arch_utils.h>

   #else

      #include <usax/common/arch/i386/utils.h>
      #include <usax/kernel/arch/i386/asm_defs.h>
      #include <usax/kernel/arch/i386/arch_utils.h>
      #include <usax/kernel/arch/i386/tss.h>
   ...
   #include <usax/common/arch/riscv/utils.h>
   #include <usax/common/arch/riscv/image.h>
   #include <usax/kernel/arch/riscv/sbi.h>
   #include <usax/kernel/arch/riscv/mmio.h>
   #include <usax/kernel/arch/riscv/ioremap.h>
   #include <usax/kernel/arch/riscv/arch_ints.h>
   #include <usax/kernel/arch/riscv/asm_defs.h>
   #include <usax/kernel/arch/riscv/arch_utils.h>
   #include <usax/kernel/arch/riscv/fpu_memcpy.h>
   #include <usax/kernel/arch/riscv/cpu_features.h>
