...
#if defined(__usax_KERNEL__) && !defined(__usax_HAL__)
   #error Never include this header directly. Do #include <usax/kernel/hal.h>.
#endif
...
struct x86_regs {
   ...
   u32 custom_flags;        /* custom usax flags */
   u32 gs, fs, es, ds;
